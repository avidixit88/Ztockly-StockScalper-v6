...
with tab_scan:
    ...
    if results:
        ...
        # NOTE: Streamlit Cloud can be picky with Styler tooltips; we show the explanation in a column instead.
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "Scale note": st.column_config.TextColumn("Scale note", help="Why the score was normalized for this ticker."),
